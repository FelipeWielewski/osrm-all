...
OSRM_PBF_URL=${OSRM_PBF_URL:="https://download.geofabrik.de/south-america/brazil/sul-latest.osm.pbf"}
...
osrm-routed --algorithm mld $OSRM_DATA_PATH/$OSRM_DATA_LABEL.osrm -p $PORT
child=$!
wait "$child"